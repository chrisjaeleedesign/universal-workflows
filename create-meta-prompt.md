...
Reference: @.agent/workflows/commands/universal-workflows/create-meta-prompt/references/intelligence-rules.md
Intake Sub-Workflow: @.agent/workflows/commands/universal-workflows/create-meta-prompt/intake.md
Generate Sub-Workflow: @.agent/workflows/commands/universal-workflows/create-meta-prompt/generate.md
</context>
...
1.  **Delegate**:
    -   Use `view_file` to read the **Intake Sub-Workflow** (`.agent/workflows/commands/universal-workflows/create-meta-prompt/intake.md`).
