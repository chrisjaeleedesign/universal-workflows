...
Reference: @.agent/workflows/universal-workflows/tools/create-meta-prompt/references/intelligence-rules.md
Intake Sub-Workflow: @.agent/workflows/universal-workflows/tools/create-meta-prompt/prompt-intake.md
Generate Sub-Workflow: @.agent/workflows/universal-workflows/tools/create-meta-prompt/prompt-generate.md
</context>
...
1.  **Delegate**:
    -   Use `view_file` to read the **Intake Sub-Workflow** (`.agent/workflows/universal-workflows/tools/create-meta-prompt/prompt-intake.md`).
